...
$ apt install git -y
$ git clone https://github.com/shopeebjm/Termux-Style
$ cd Termux-Style
$ python2 style5.py

- kemudian di arahkan ke akun YouTube! Tidak Perlu Khawatir Sampai Di Step Ini,Kemudian Kalian Back Ke Termux.
- Selanjutnya Untuk Mengsintall Bahannya Pilih Nomor 2
- Setelah Bahan Terinstall Kemudian Tekan Enter Untuk Login Scriptnya
...
‎<a href="https://shopee.co.id/infinixnote40bjm"> <img src="https://cdn.jsdelivr.net/npm/simple-icons@3.0.1/icons/shopee.svg" height='50'>
‎
